 ...
 * mock路由规则
 */
router.get("/shop_goods", function (req, res) {
  res.send({ code: 0, data: mockData.goods });
});
router.get("/shop_ratings", function (req, res) {
  res.send({ code: 0, data: mockData.ratings });
});
router.get("/shop_info", function (req, res) {
  res.send({ code: 0, data: mockData.info });
});
